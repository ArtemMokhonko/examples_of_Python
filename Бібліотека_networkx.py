...
"""
Давайте спробуємо використати networkX для візуалізації графа міст і доріг.
...
# """
# алгоритм Дейкстри будемо використовувати простий пошук вершини з найменшою відстанню в невідвіданих вершинах
# """
